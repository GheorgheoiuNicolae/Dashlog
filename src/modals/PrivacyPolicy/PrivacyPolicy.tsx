...
export default class PrivacyPolicyModal extends React.Component<Props, {}> {
  ...
  render() {
    ...
    return (
      <Dialog
        modal={true}
        open={activeModal.name === 'privacyPolicy'}
      ...
      >
        ...
        <section className="content">
          <p> Nicolae Gheorgheoiu built the Dashlog app as an Ad Supported app. 
            This SERVICE is provided by Nicolae Gheorgheoiu at no cost and is intended for use as is.
          </p>
          ...
          <p>
            ...
            at Dashlog unless otherwise defined in this Privacy Policy.
          </p>
          <p><strong>Information Collection and Use</strong></p> 
          <p>For a better experience, while using our Service, I may require you to provide us with certain
            personally identifiable information, including but not limited to email, name, age, gender,photos. 
          ...
          <ul>
            <li><a href="https://www.google.com/policies/privacy/" target="_blank">Google Services</a></li> 
          </ul>
        ...
        <footer className="modal-footer">
          <RaisedButton
            ...
            onClick={() => this.closeModal('privacyPolicy')}
          />
          <RaisedButton
            onClick={() => this.closeModal('privacyPolicy')}
            label="I Agree"
